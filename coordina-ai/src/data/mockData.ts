...
export const MOCK_PROJECT: Project = {
  ...
  tasks: [
    { id: 't1', title: 'Define BLE beacon placement strategy', status: 'done', assigneeId: 'm1', dueDate: '2026-04-10', priority: 'high', tags: ['hardware', 'planning'], description: 'Map optimal beacon positions for 90% indoor coverage.' },
    { id: 't2', title: 'Set up computer vision pipeline', status: 'done', assigneeId: 'm2', dueDate: '2026-04-12', priority: 'high', tags: ['AI', 'core'], description: 'Implement YOLOv8 for landmark recognition.' },
    { id: 't3', title: 'Design user journey flows', status: 'done', assigneeId: 'm5', dueDate: '2026-04-14', priority: 'medium', tags: ['UX'], description: 'Wireframes for onboarding and navigation.' },
    { id: 't4', title: 'Build REST API for location data', status: 'in_progress', assigneeId: 'm4', dueDate: '2026-04-28', priority: 'high', tags: ['backend', 'API'], description: 'FastAPI endpoints for real-time location queries.' },
    { id: 't5', title: 'Implement navigation UI', status: 'in_progress', assigneeId: 'm3', dueDate: '2026-05-01', priority: 'high', tags: ['frontend'], description: 'AR overlay navigation view in React Native.' },
    { id: 't6', title: 'Train room classification model', status: 'in_progress', assigneeId: 'm2', dueDate: '2026-04-30', priority: 'high', tags: ['AI', 'ML'], description: 'Dataset curation and model training.' },
    { id: 't7', title: 'Write system architecture document', status: 'review', assigneeId: 'm1', dueDate: '2026-04-25', priority: 'medium', tags: ['docs'], description: 'Complete technical specification.' },
    { id: 't8', title: 'Conduct usability testing session', status: 'review', assigneeId: 'm5', dueDate: '2026-04-26', priority: 'medium', tags: ['UX', 'testing'], description: '3 rounds with 5 participants each.' },
    { id: 't9', title: 'Integration testing — full system', status: 'backlog', assigneeId: 'm4', dueDate: '2026-05-08', priority: 'high', tags: ['testing'], description: 'End-to-end test all subsystems.' },
    { id: 't10', title: 'Prepare final presentation slides', status: 'backlog', assigneeId: 'm1', dueDate: '2026-05-12', priority: 'medium', tags: ['deliverable'], description: '15-slide deck for project showcase.' },
    { id: 't11', title: 'Write rubric reflection report', status: 'backlog', assigneeId: 'm3', dueDate: '2026-05-13', priority: 'medium', tags: ['docs'], description: 'Self-assessment against grading rubric.' },
  ],
};
